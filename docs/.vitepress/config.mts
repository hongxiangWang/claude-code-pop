...
export default defineConfig({
  ...
  locales: {
    ...
    en: {
      ...
      themeConfig: {
        editLink: {
          pattern: 'https://github.com/hongxiangWang/claude-code-pop/edit/main/docs/:path',
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/hongxiangWang/claude-code-pop' },
    ],
    footer: {
      message: 'Released under the MIT License.',
      copyright: 'Copyright 2026 Claude Code POP Contributors',
    },
  },
})
