...
[![GitHub Stars](https://img.shields.io/github/stars/hongxiangWang/claude-code-pop?style=social)](https://github.com/hongxiangWang/claude-code-pop/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/hongxiangWang/claude-code-pop?style=social)](https://github.com/hongxiangWang/claude-code-pop/network/members)
[![GitHub Issues](https://img.shields.io/github/issues/hongxiangWang/claude-code-pop)](https://github.com/hongxiangWang/claude-code-pop/issues)
[![GitHub Pull Requests](https://img.shields.io/github/issues-pr/hongxiangWang/claude-code-pop)](https://github.com/hongxiangWang/claude-code-pop/pulls)
[![License](https://img.shields.io/github/license/hongxiangWang/claude-code-pop)](https://github.com/hongxiangWang/claude-code-pop/blob/main/LICENSE)
...
- Fallback Recovery CLI mode (`CLAUDE_CODE_FORCE_RECOVERY_CLI=1 ./bin/pop-claude`)
...
```bash
./bin/pop-claude                          # Interactive TUI mode
./bin/pop-claude -p "your prompt here"    # Headless mode
./bin/pop-claude --help                   # Show all options
```
...
| [Global Usage](docs/en/guide/global-usage.md) | Run pop-claude from any directory |
